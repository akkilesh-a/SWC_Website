...
const StudentWelfareCommitteeDescription=()=>{
    return(
        <div className='text-center flex flex-col justify-center items-center space-y-8 p-16'>
            <SubHeading className='underline font-bold font-dmSerifDisplay text-7xl'>Student Welfare Committee</SubHeading>
            <div  className='w-[400px] md:w-[700px] font-dmSerifText'>
                <Text>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec sem ex, 
