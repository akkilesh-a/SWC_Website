...
const OfficeBearerCard = ({
  ...
  >
    ...
    <div className="flex flex-col justify-center md:p-12 md:space-y-3 md:w-1/2">
      <SubHeading className="underline flex justify-center  md:justify-start">
        {name}
      </SubHeading>
      <Text className="md:text-3xl xl:text-4xl font-bold flex justify-center md:justify-start">
        {designation}
      </Text>
      <Text className="flex justify-center text-center md:text-left p-7 md:w-[35vw] md:p-0">
        {description}
      </Text>
    </div>
  </div>
